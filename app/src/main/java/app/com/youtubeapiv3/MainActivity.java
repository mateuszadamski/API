...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Best channel"));
        tabLayout.addTab(tabLayout.newTab().setText("Awesome playList"));
        tabLayout.addTab(tabLayout.newTab().setText("Live music"));
